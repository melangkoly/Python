...
def test_insert_many():
    ...
    # 여러 문서 삽입시에는 [] 로 문서 전달
    xs = coll.insert_many([{"name": "고길동", "address": "서울", "method": "insert_many"},
    ...
    print(len(xs.inserted_ids), "개의 레코드 삽입됨")

def test_update():
    # address == "서울"
    # method -> update, modified at -> 현재 시간
    coll = test_collection()
...
def test_delete_by_filter(filter={}):
    ...
    print(xs.deleted_count, "개의 레코드 삭제!")
...
if __name__ == "__main__":
    ...
    # Select * FROM 테이블 명 Where 컬럼 LIKE ->
    # 정규식을 이용한 패턴 전달
